...
const Category = ({ category, products, slug }) => {
    ...
    // const { data, error, isLoading } = useSWR(`/api/products?populate=*&filters[categories][slug][$eq]=${slug}&pagination[page]=${pageIndex}&pagination[pageSize]=${maxCount}`,
    //     fetchDataFromApi,
    //     {
        ...
        <div className="w-full md:py-20 relative">
            <Wrapper>
                ...
                {/* PAGINATION BUTTONS START */}
                 {/* {data?.meta?.pagination?.total > maxCount && (
